...
export const EXTRA = {
  ...
  // ============== APP ==============
  'app.brand': { ja: 'CHRTV PLAY', ko: 'CHRTV PLAY', th: 'CHRTV PLAY', id: 'CHRTV PLAY', ms: 'CHRTV PLAY', hi: 'CHRTV PLAY', de: 'CHRTV PLAY', es: 'CHRTV PLAY', pt: 'CHRTV PLAY', ru: 'CHRTV PLAY' },
  'app.tagline': { ja: 'ライブTV＆映画オンライン', ko: '실시간 TV & 영화 온라인', th: 'ทีวีสด & หนังออนไลน์', id: 'TV Langsung & Film Online', ms: 'TV Langsung & Filem Dalam Talian', hi: 'लाइव टीवी और फिल्में ऑनलाइन', de: 'Live-TV & Filme online', es: 'TV en vivo y películas en línea', pt: 'TV ao vivo e filmes online', ru: 'Прямой эфир и фильмы онлайн' },
