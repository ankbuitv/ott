...
const T = {
  ...
  // --- trạng thái nguồn / khởi chiếu của phim (xem src/utils/release.js) ---
  'movies.btn.trailer':            { vi: 'Xem trailer',             en: 'Watch trailer',           zh: '观看预告片',                fil: 'Panoorin ang trailer',             fr: 'Voir la bande-annonce' },
  'movies.badge.soon':             { vi: 'Sắp chiếu',               en: 'Coming soon',             zh: '即将上映',                   fil: 'Malapag inilabas',                 fr: 'Bientôt' },
  ...
  'settings.sess_kick_others': { vi: 'Đá hết thiết bị khác', en: 'Sign out all other devices' },
  ...
  'plans.sec1': { vi: 'Xem trên web, điện thoại và TV', en: 'Watch on web, phone and TV' },
  ...
  'apk.wait': { vi: 'Vui lòng chờ trong giây lát', en: 'Please wait a moment' },
  'apk.download': { vi: 'Tải APK ngay', en: 'Download APK' },
  'nav.subscribe': { vi: 'Đăng ký gói', en: 'Subscribe' },
  'nav.switch_account': { vi: 'Chuyển tài khoản', en: 'Switch profile' },
  'nav.manage_profiles': { vi: 'Quản lý hồ sơ', en: 'Manage profiles' },
  'nav.account_settings': { vi: 'Tài khoản & cài đặt', en: 'Account & settings' },
  'nav.add_account': { vi: 'Thêm tài khoản', en: 'Add account' },
  'nav.adult': { vi: 'Người dùng', en: 'Adult' },
  'nav.kids': { vi: 'Trẻ em', en: 'Kids' },
  'plans.buy_now': { vi: 'Mua ngay', en: 'Buy now' },
  'plans.compare': { vi: 'So sánh gói', en: 'Compare plans' },
  'plans.feature': { vi: 'Quyền lợi', en: 'Features' },
  ...
  // ---- Đợt 48: mã chia sẻ / nhập mã / resume / follow series / sao creator / wrapped ----
  'p48.enter_code': { vi: 'Nhập mã 🎟️', en: 'Enter code 🎟️' },
  'p48.enter_code_ph': { vi: 'Nhập mã chia sẻ…', en: 'Enter share code…' },
  'p48.use': { vi: 'Dùng mã', en: 'Use code' },
  'p48.code_ok': { vi: 'Mã hợp lệ — đang mở!', en: 'Code OK — opening!' },
  'p48.code_bad': { vi: 'Mã không đúng hoặc đã hết hạn', en: 'Invalid or expired code' },
  'p48.gen_code': { vi: 'Tạo mã', en: 'Create code' },
  'p48.code_copied': { vi: 'Đã chép mã', en: 'Code copied' },
  'p48.code_hint': { vi: 'Mã có hạn 10 phút, dùng được nhiều lần', en: 'Code lasts 10 minutes, unlimited uses' },
  'p48.code_ttl': { vi: 'Hết hạn sau', en: 'Expires in' },
  'p48.make_code': { vi: 'Tạo mã chia sẻ 6 ký tự', en: 'Create 6-char share code' },
  'p48.resume_code_title': { vi: 'Đồng bộ TV 📺', en: 'Sync to TV 📺' },
  'p48.resume_code_hint': { vi: 'Nhập mã 6 số trên TV để mở tiếp đúng tập đúng phút', en: 'Enter the 6-digit code on TV to resume exactly where you left' },
  'p48.code_6': { vi: 'Mã 6 số', en: '6-digit code' },
  'p48.follow_series': { vi: 'Theo dõi series', en: 'Follow series' },
  'p48.following': { vi: 'Đang theo dõi', en: 'Following' },
  'p48.new_ep': { vi: 'TẬP MỚI', en: 'NEW EP' },
  'p48.new_ep_toast': { vi: 'Tập mới đã lên! Xem ngay nhé.', en: 'New episode is out!' },
  'p48.voice_comment': { vi: 'Ghi chú thoại', en: 'Voice note' },
  'p48.recording': { vi: 'Đang ghi…', en: 'Recording…' },
  'p48.rec_done': { vi: 'Đã ghi — gửi kèm bình luận', en: 'Recorded — send with comment' },
  'p48.star_short': { vi: 'Tặng sao', en: 'Send star' },
  ...
  'p48.claim_invite': { vi: 'Nhận thưởng', en: 'Claim reward' },
  'p48.wrapped_title': { vi: 'Năm của bạn', en: 'Your year' },
  'p48.wrapped_btn': { vi: 'Xem Wrapped', en: 'View Wrapped' },
  'p48.cinema_mode': { vi: 'Rạp phim', en: 'Cinema mode' },
  'p48.data_saver': { vi: 'Tiết kiệm data', en: 'Data saver' },
  'p48.status_plan': { vi: 'Kế hoạch xem', en: 'Watch plan' },
  'p48.want_watch': { vi: 'Muốn xem', en: 'Want' },
  'p48.watching_now': { vi: 'Đang xem', en: 'Watching' },
  'p48.watched': { vi: 'Đã xem', en: 'Watched' },
  'p48.sponsored': { vi: 'Tài trợ', en: 'Sponsored' },
  'p48.maintenance': { vi: 'Đang bảo trì', en: 'Maintenance' },
  'p48.region_blocked': { vi: 'Không khả dụng ở vùng', en: 'Not available in' },
  'p48.region_blocked_hint': { vi: 'Nội dung này bị chặn tại quốc gia hiện tại của bạn', en: 'Content is blocked in your current region' },
  'p48.geo_hot': { vi: 'Đang hot tại', en: 'Hot in' },
  'p48.channel_alt': { vi: 'Kênh thay thế', en: 'Alternative channels' },
  'p48.quiz_title': { vi: 'Chọn sở thích của bạn', en: 'Pick your interests' },
  'p48.quiz_hint': { vi: '3 câu hỏi để cá nhân hoá trang chủ — đổi được bất cứ lúc nào', en: '3 questions to personalize home — change anytime' },
  ...
  'p48.set_maintenance': { vi: 'Bảo trì kênh', en: 'Channel maintenance' },
  'p48.theater_ui': { vi: 'Giao diện rạp', en: 'Cinema UI' },
  'p48.follow_team': { vi: 'Theo dõi đội', en: 'Follow team' },
